...
## WARNING
 ...
 If you were using version 0.67, and are going to update, you will lose all of you information if you're not careful, this is caused to to the switch from AES-128-CBC to AES-256-GCM. You will need to completly rewrite everything currently (but still easily drag and drop passwords from the old manager to the new) and I'm not going to create a method to encode everything from a old method to a new method. STAY SAFE AND MAKE BACKUPS
